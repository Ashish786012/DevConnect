    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_stackoverflow', models.CharField(blank=True, max_length=150, null=True)),
                ...
                ('social_medium', models.CharField(blank=True, max_length=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_read_date', models.DateTimeField(blank=True, null=True)),
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
